        ...
        match key_code {
            Some(key_code) => {
                match key_code {
                    ...
                    VirtualKeyCode::Add => Self::NumpadAdd,
                    ...
                    VirtualKeyCode::Decimal => Self::NumpadDecimal,
                    VirtualKeyCode::Divide => Self::NumpadSlash,
                    ...
                    VirtualKeyCode::Multiply => Self::NumpadMultiply,
                    ...
                    VirtualKeyCode::Subtract => Self::NumpadMinus,
